...
$BDC_Include_Path = \CakeCaptcha\Support\Path::getCaptchaLibPath() . '/botdetect/';


// physical path of xml(json) config file path
$BDC_Config_File_Path = \CakeCaptcha\Support\Path::getCakePHPConfigPath('botdetect.xml');
...
$BDC_Handler_Path = \Cake\Routing\Router::url('/', true) . 'simple-captcha-handler';;
